...
export async function sendTicketEmail({
  ...
  const formattedPrice = eurFmt.format(price);
...
<body style="margin:0;padding:0;background-color:#f4f4f5;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
      ...
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#ffffff;border-radius:8px;overflow:hidden;">
          ...
          <tr>
            <td style="background-color:#1a7fc7;padding:32px 40px;text-align:center;">
              <h1 style="margin:0;color:#ffffff;font-size:28px;font-weight:800;letter-spacing:1px;">VOLUME</h1>
              <p style="margin:8px 0 0;color:rgba(255,255,255,0.85);font-size:14px;">Your Event Ticket</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 20px;font-size:16px;line-height:1.6;color:#18181b;">
                Your ticket for <strong>${eventName}</strong> is confirmed. Here are the details:
              </p>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;border:1px solid #e4e4e7;border-radius:6px;margin:24px 0;">
                <tr>
                  <td style="padding:24px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:0 0 12px;font-size:13px;color:#71717a;text-transform:uppercase;letter-spacing:0.5px;">Event</td>
                        <td style="padding:0 0 12px;font-size:15px;color:#18181b;font-weight:600;text-align:right;">${eventName}</td>
                      </tr>
                      ${
                        venueName
                          ? `<tr>
                        <td style="padding:12px 0;font-size:13px;color:#71717a;text-transform:uppercase;letter-spacing:0.5px;border-top:1px solid #e4e4e7;">Venue</td>
                        <td style="padding:12px 0;font-size:15px;color:#18181b;font-weight:600;text-align:right;border-top:1px solid #e4e4e7;">${venueName}</td>
                      </tr>`
                          : ""
                      }
                      <tr>
                        <td style="padding:12px 0;font-size:13px;color:#71717a;text-transform:uppercase;letter-spacing:0.5px;border-top:1px solid #e4e4e7;">Date</td>
                        <td style="padding:12px 0;font-size:15px;color:#18181b;font-weight:600;text-align:right;border-top:1px solid #e4e4e7;">${formattedDate}</td>
                      </tr>
                      <tr>
                        <td style="padding:12px 0 0;font-size:13px;color:#71717a;text-transform:uppercase;letter-spacing:0.5px;border-top:1px solid #e4e4e7;">Price Paid</td>
                        <td style="padding:12px 0 0;font-size:15px;color:#18181b;font-weight:600;text-align:right;border-top:1px solid #e4e4e7;">${formattedPrice}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:32px 0;">
                <tr>
                  <td align="center">
                    <a href="${ticketUrl}" style="display:inline-block;background-color:#18181b;color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;padding:14px 40px;border-radius:4px;text-transform:uppercase;letter-spacing:0.5px;">
                      View Your Ticket
                    </a>
                  </td>
                </tr>
              ...
              <ol style="margin:0 0 24px;padding-left:20px;font-size:14px;line-height:1.8;color:#3f3f46;">
                <li>Open the ticket link above on your phone when you arrive at the venue.</li>
                <li>Show the screen to the staff at the door.</li>
                <li>The staff will validate your entry.</li>
              </ol>
  ...
  const result = await resend.emails.send({
    from: FROM_EMAIL,
    to,
    subject: `Your Volume Brussels Ticket — ${eventName}`,
    html,
  });
